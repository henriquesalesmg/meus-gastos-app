<div class="my-auto max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="createExpense" class="w-full max-w-7xl mx-auto py-20">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                ...
                <input type="date" name="expense_date" wire:model="expenseDate"
        ...
        <div class="w-full py-4 px-3 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="flex-shrink-0 bg-gray-500 hover:bg-gray-700 border-gray-500 hover:border-gray-700 text-sm border-4 text-white py-1 px-2 rounded">Criar Registro</button>
        </div>
